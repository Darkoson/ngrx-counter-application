...
export const LoginSuccessAction = createAction(type.LOGIN_SUCCESS, props<{user: User}>()) ;
...
export const SignupSuccessAction = createAction(type.SIGNUP_SUCCSESS, props<{user: User}>())