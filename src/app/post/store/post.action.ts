...
export const PostUpdateSuccessAction = createAction(PostActionType.POST_UPDATE_SUCCESS, props<{post: Post}>())

export const PostDeleteAction = createAction(PostActionType.POST_DELETE, props<{id:string}>())
export const PostDeleteSuccessAction = createAction(PostActionType.POST_DELETE_SUCCESS, props<{id:string}>())
